...
conftest.py (loads first).

Declares the same plugin as tests/python/conftest.py — pytest registers
the name once, so ``pytest tests/python tests/e2e`` runs as ONE command.
"""

...
SPECS = [
    ...
    ToolSpec("tasks.complete", "Mark a task as done by id.", tasks_complete, PolicyKind.USER_VISIBLE),
    ToolSpec("memory.remember", "Store a small durable fact (key/value).", memory_remember, PolicyKind.USER_VISIBLE),

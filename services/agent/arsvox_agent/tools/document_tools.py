...
SPECS = [
    ...
    ToolSpec("document.open", "Open an existing document by title. Call document.list first to see what exists.", document_open, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("document.list", "List all saved documents.", document_list, PolicyKind.READ_ONLY, effect="revertible"),
    ToolSpec("document.search", "Search documents by title fragment.", document_search, PolicyKind.READ_ONLY, effect="revertible"),
    ToolSpec(
        "document.save",
    ...
    ToolSpec("document.undo", "Undo the last edit.", document_undo, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("document.redo", "Redo the last edit.", document_redo, PolicyKind.REVERSIBLE, effect="revertible"),
]

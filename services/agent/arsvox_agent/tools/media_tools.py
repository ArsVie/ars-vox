...
SPECS = [
    ...
    ToolSpec("media.pause", "Pause the current media.", media_pause, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("media.resume", "Resume the current media.", media_resume, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("media.stop", "Stop the current media.", media_stop, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("media.seek", "Seek to a position in seconds.", media_seek, PolicyKind.REVERSIBLE, effect="revertible"),
    ToolSpec("media.set_volume", "Set media volume, 0.0 to 1.0.", media_set_volume, PolicyKind.REVERSIBLE, effect="revertible"),
]

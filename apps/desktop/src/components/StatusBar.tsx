 ...
 * composer (like usual chat UIs), and STOP lives inside it. Two shell
 * remnants stay global: the ARS·VOX wordmark (home affordance, top-left)
 * and a floating status fallback for layouts without the conversation
 * surface (so the voice state + STOP remain reachable everywhere).
 */
 ...
 * voice-state pill + turn timer left, STOP right. No home button, no
 * activity line, no connection text — this row is the single indicator.
 */

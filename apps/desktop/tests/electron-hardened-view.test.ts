/**
 * A8 (GATE-3.5 wave 1) — tests for the Electron glue (R40/R41):
 * hardened session/view creation, navigation guards, local-doc protocol
 * handler, IPC sender validation, global WebContents guard.
 *
...
import { LOCAL_DOC_SCHEME, REMOTE_CONTENT_PARTITION } from "../electron/security-policy";

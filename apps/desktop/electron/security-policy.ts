/**
 * A8 (GATE-3.5 wave 1) — Electron security policy primitives (R40/R41/R42).
 *
...
/**
 * Mirrors configs/app.yaml browser.allowlist default. NOTE: does NOT yet
 * include youtube-nocookie.com — the YouTube embed allowlist gap is
 * documented in docs/migration-note-electron-upgrade-2026-08-08.md.
 */
...
/**
 * Exact origin set the YouTube embed/player allowlist needs (R42
 * deliverable). Host-level allowlist entries required:
 *   youtube.com, *.youtube.com            (covers www/m/music/consent)
 *   youtube-nocookie.com, *.youtube-nocookie.com   (privacy-enhanced embeds)
 * `youtube-nocookie.com` is a DIFFERENT registrable domain — the current
 * config default does not cover it.
 */

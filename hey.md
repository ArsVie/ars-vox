...
- files/dirs: `apps/desktop/src/App.tsx`, `apps/desktop/src/components/{PanelHost,StatusBar,PlaceholderSurface(new),PersistentRegions(new)}.tsx`, `apps/desktop/src/styles.css`, `apps/desktop/tests/shell.test.tsx (new)`, `hey.md`
